...
df_cleaned = df_cleaned.dropna(subset=["Voltage_in_V"])
df_cleaned = df_cleaned.dropna(subset=["Capacity_per_gram_in_mAh"])
...
df_cleaned.to_csv("Data/Merged_Cleaned/Distinct_Name_All_Properties_Merged_V4.csv", index=False)

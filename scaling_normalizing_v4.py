...
file_path = "Data/Merged_Cleaned/Distinct_Name_All_Properties_Merged_V4.csv"
...
standard_scaled_df.to_csv("Data/Scaled_dataset/Scaled_dataset_V4.csv", index=False)

# Normalization
scaler_norm = MinMaxScaler()
normalized_df = df.copy()
normalized_df[columns_to_scale] = scaler_norm.fit_transform(df[columns_to_scale])
normalized_df.to_csv("Data/Scaled_dataset/Normalized_dataset_V4.csv", index=False)
